      ...
      <div className='m-auto max-w-6xl p-2 md:p-12 h-5/6' id='about'>
        ...
        >
          ...
          >
            ...
            <Link
              to='/contact'
              className='text-white bg-blue-500 hover:bg-blue-800 inline-flex items-center justify-center w-full px-6 py-2 my-4 text-lg shadow-xl rounded-2xl sm:w-auto sm:mb-0 group'
            >
              Contact us
              <svg
