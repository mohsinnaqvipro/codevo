      ...
      <section data-aos='zoom-in-down'>
        <div className='my-4 py-4'>
          ...
          <div className='flex justify-center'>
            <div className='w-36 border-b-4 border-blue-500'></div>
          </div>
          ...
          <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-5'>
            ...
            <div className='bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group'>
              <div className='m-2 text-justify text-sm'>
                ...
                <p className='text-md font-medium'>
                  Our proficiency speaks through our web designs, UI/UX finesse,
                  and logo expertise. Elevate your brand with our seasoned
                  experience in crafting online identities that make a lasting
                  impact.
                </p>
              </div>
            </div>
        ...
        <div className='m-auto max-w-6xl p-2 md:p-12 h-5/6'>
          ...
          >
            <div className='lg:w-1/2 flex flex-col lg:mx-4 justify-center'>
              ...
              <div>
                <p className='my-3 text-xl text-black-500 font-semibold'>
