              ...
              <div className='mx-auto text-center mt-2'>
                <ul className='flex justify-center mb-4 md:mb-0'>
                  <li>
                    <Link
                      to='#'
                      className='flex justify-center items-center text-blue-500 hover:text-black-500 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out'
                      aria-label='Twitter'
                    >
                      <svg
