        ...
        >
          <div className='flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left'>
            <div
              ...
              data-aos-delay='200'
            >
              <h1 className='mb-5 md:text-5xl text-3xl font-bold text-blue-500'>
                {/* We build digital solutions to help businesses scale */}
                We build attractive websites, CRM, SAAS, E-commerce, and Mobile
                Applications for your unique business needs
              </h1>
              <div className='text-xl font-semibold tracking-tight mb-5 text-black-500'>
              ...
              <div className='mb-4 space-x-0 md:space-x-2 md:mb-8'>
                <Link
                  to='/contact'
                  className='text-white bg-blue-500 hover:bg-blue-800 inline-flex items-center justify-center w-full px-6 py-3 my-4 text-lg shadow-xl rounded-2xl sm:w-auto sm:mb-0'
                >
                  Learn more
                  <svg
