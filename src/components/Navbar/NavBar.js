  ...
  return (
    ...
    >
      <div className='flex flex-row justify-between items-center py-2'>
        <div className='flex flex-row justify-center md:px-12  items-center text-center font-semibold'>
          <Link to='/'>
            <img
              style={{ maxWidth: '50%' }}
              src={logo}
              alt='Codevo Technologies Logo'
            />
          </Link>
        </div>
        <div className='group flex flex-col items-center'>
          <button
            className='p-2 rounded-lg lg:hidden text-blue-500'
            onClick={handleClick}
          >
            <svg
